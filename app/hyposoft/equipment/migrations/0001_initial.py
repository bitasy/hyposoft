    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datacenter', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='equipment.Datacenter')),
                ('decommissioned_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='decommissioned_assets', to=settings.AUTH_USER_MODEL)),
