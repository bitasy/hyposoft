# Generated by Django 3.0.3 on 2020-02-25 00:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostname', models.CharField(blank=True, max_length=64, unique=True, validators=[django.core.validators.RegexValidator('^&|([a-zA-Z0-9](?:(?:[a-zA-Z0-9-]*|(?<!-)\\.(?![-.]))*[a-zA-Z0-9]+)?)$', message='Hostname must be compliant with RFC 1034.')])),
                ...
                ('mac_address', models.CharField(blank=True, max_length=17, validators=[django.core.validators.RegexValidator('^$|^([0-9a-fA-F]{2}[:-_]{0,1}){5}[0-9a-fA-F]{2}$', message='Your MAC Address must be in valid hexadecimal format (e.g. 00:1e:c9:ac:78:aa).')])),
            ],
        ),
        migrations.CreateModel(
            name='Datacenter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rack', models.CharField(default='A0', max_length=4, unique=True, validators=[django.core.validators.RegexValidator('^[A-Z]{1,2}[0-9]{2}$', message='Row number must be specified by one or two capital letters.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='equipment.Asset')),
                ('connection', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='equipment.NetworkPort')),
